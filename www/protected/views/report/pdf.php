...
$pdf = Yii::createComponent('application.extensions.ETcPdf', 
                            'P', 'cm', 'A4', true, 'UTF-8');
...
//$pdf->SetAutoPageBreak(TRUE, PDF_MARGIN_BOTTOM); // Hang in Yii
