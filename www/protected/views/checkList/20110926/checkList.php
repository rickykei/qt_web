...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/search.js"></script>
 ...
 <div id="content">
	...
	<div id="rightcol">
		<ul>
		<li class="row">
			<? echo CHtml::image(Yii::app()->request->baseUrl.'/images/checklist_create.png', '', array('class'=>'rowpic', '')); ?>
			<form  id="checklist_create" action="create_new_checklist.php" >
			To add a new check list template, click here!
			<input type="button" alt="checkListHeader?KeepThis=true&TB_iframe=true&height=380&width=530&modal=true" title="" class="createBtn thickbox" value=""/>
			</form>
